...
//controller
const { insertPhoto, deletePhoto, getAllPhotos, getUserPhotos, updatePhoto, likePhoto, commentPhoto, searchPhotos, getPhotoById } = require("../controllers/PhotoController");
